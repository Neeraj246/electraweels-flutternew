...
class Servicereg extends StatefulWidget {
  const Servicereg({super.key});

  @override
  State<Servicereg> createState() => _ServiceregState();
}

class _ServiceregState extends State<Servicereg> {
