...
class Stationreg extends StatefulWidget {
  const Stationreg({super.key});

  @override
  State<Stationreg> createState() => _StationregState();
}

class _StationregState extends State<Stationreg> {
